                  ...
                  if (alt == 'alt-one') {
                    console.log('no-widg: ' + alt);
                      var no_widg_script= $("<script>", {
                          type: "text/javascript",
                          async: true,
                          src: "https://cdn.rawgit.com/dish615/devAbTest8/master/no-widg.js"
                      });
                    ...
                    var css_link = $("<link>", { 
                        rel: "stylesheet", 
                        type: "text/css", 
                        href: "https://cdn.rawgit.com/dish615/devAbTest8/master/style.css" 
                   ...
                   var widg_script = $("<script>", {
                       type: "text/javascript",
                        async: true,
                        src: "https://cdn.rawgit.com/dish615/devAbTest8/master/check.js"
                    });
                    ...
                    var jsonp_url= "https://cdn.rawgit.com/dish615/devAbTest8/master/index.html";
